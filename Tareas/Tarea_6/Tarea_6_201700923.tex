...
\multirow{4}{*}{\includegraphics[scale=0.3]{EIME.png}}                                                         & \multicolumn{3}{l}{Ingeniería electrónica}                                       \\
	...
	\multicolumn{1}{|l|}{Carné:} & 201700923 & Fecha: & \multicolumn{1}{l|}{17/2/2022}\\ 
	\hline 
...
\verbatiminput{Convolución.py}

\section{Resultados}

\begin{figure}[H]
\centering
\includegraphics[scale=1]{ploteo.png}
\caption{Resultados del código.}
\end{figure}
